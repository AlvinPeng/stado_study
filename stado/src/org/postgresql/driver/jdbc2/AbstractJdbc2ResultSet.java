...
import org.postgresql.driver.util.PGbytea;
import org.postgresql.driver.util.PGobject;
import org.postgresql.driver.util.PGtokenizer;
import org.postgresql.driver.util.PSQLException;
import org.postgresql.driver.util.PSQLState;


public abstract class AbstractJdbc2ResultSet implements BaseResultSet, org.postgresql.driver.PGRefCursorResultSet
{
    ...
    {
        checkClosed();
        throw org.postgresql.driver.Driver.notImplemented(this.getClass(), "getURL(int)");
    }
    ...
    public Object getObjectImpl(int i, java.util.Map map) throws SQLException
    {
        ...
        throw org.postgresql.driver.Driver.notImplemented(this.getClass(), "getObjectImpl(int,Map)");
    }
    ...
    public Ref getRef(int i) throws SQLException
    {
        ...
        throw org.postgresql.driver.Driver.notImplemented(this.getClass(), "getRef(int)");
    }
