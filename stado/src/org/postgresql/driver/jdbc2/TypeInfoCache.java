...
import org.postgresql.driver.core.Oid;
import org.postgresql.driver.core.QueryExecutor;
import org.postgresql.driver.core.TypeInfo;
...
public class TypeInfoCache implements TypeInfo {
    ...
    public synchronized void addDataType(String type, Class klass) throws SQLException
    {
        if (!PGobject.class.isAssignableFrom(klass))
            throw new PSQLException(GT.tr("The class {0} does not implement org.postgresql.driver.util.PGobject.", klass.toString()), PSQLState.INVALID_PARAMETER_TYPE);
