...
import org.postgresql.driver.copy.*;
 ...
 * The real Connection class (for jdbc2) is org.postgresql.driver.jdbc2.Jdbc2Connection
 */
public abstract class AbstractJdbc2Connection implements BaseConnection
{
     ...
     * type is not supported, then an instance of org.postgresql.driver.util.PGobject
     * is returned.
     *
