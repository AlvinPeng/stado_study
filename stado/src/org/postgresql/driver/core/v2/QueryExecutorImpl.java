...
public class QueryExecutorImpl implements QueryExecutor {
    ...
    public void fetch(ResultCursor cursor, ResultHandler handler, int rows) throws SQLException {
        throw org.postgresql.driver.Driver.notImplemented(this.getClass(), "fetch(ResultCursor,ResultHandler,int)");
    }
    ...
    private void receiveAsyncNotify() throws IOException {
        ...
        protoConnection.addNotification(new org.postgresql.driver.core.Notification(msg, pid));
    }
